...
public class QueryDTOTest {
    ...
    public void interpretAll() {
        ...
        sort.setFeatureName(QueryFieldDTO.of("book"));
        sort.setDirection(SortDTO.Direction.DESC);
        queryDTO.setOrders(Arrays.asList(sort));
        queryDTO.setFields(Arrays.asList(QueryFieldDTO.of("book"), QueryFieldDTO.of("author")));
        ...
        firstExpression.setValue(QueryFieldDTO.of("2019-01-"));
        firstExpression.setFeatureName(QueryFieldDTO.of("date"));
        ...
        secondExpression.setFeatureName(QueryFieldDTO.of("date"));
        secondExpression.setValues(Arrays.asList(QueryFieldDTO.of("2019-01-10"), QueryFieldDTO.of("2019-01-11")));
